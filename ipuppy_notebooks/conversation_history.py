...
class ConversationHistory:
    ...
    def __init__(self, history_dir: str = "conversation_history"):
        ...
        logger.info(f"ConversationHistory initialized with directory: {self.history_dir}")
    ...
    def load_conversation_history(self, notebook_name: str) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.info(f"Loaded {len(history)} conversation entries for {notebook_name}")
            return history
    ...
    def save_conversation_history(self, notebook_name: str, history: List[Dict[str, Any]]) -> bool:
        ...
        try:
            ...
            logger.info(f"Saved {len(history)} conversation entries for {notebook_name}")
            return True
    ...
    def add_message(self, notebook_name: str, role: str, message: str, metadata: Optional[Dict[str, Any]] = None) -> bool:
    ...
    def clear_history(self, notebook_name: str) -> bool:
        ...
        try:
            ...
            logger.error(f"Error clearing conversation history for {notebook_name}: {e}")
            return False
